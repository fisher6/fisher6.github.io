    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                var dowClass = ["wd", "wd", "wd", "wd", "wd", "wd", "sa"]; // Gal: dowClass[0] (sunday) was "sn", changed to "wd"
        ...
        this.each(function () {
            ...
            case "hours":
                this.headerRows = 5;
                this.scaleStep = 6; // Gal: originally 1, changed to 12 to show only 2 hour-timeslots per day
                break;
            case "weeks":
                this.headerRows = 3;
                this.scaleStep = 13;
